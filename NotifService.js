...
export default class NotifService {
  ...
  localNotif(soundName) {
    ...
    PushNotification.localNotification({
      ...
      bigText: soundName.title, // (optional) default: "message" prop
      subText: soundName.message, // (optional) default: none
      ...
      title: soundName.title, // (optional)
      message: soundName.message, // (required)
